...
exports.premium = () => {
	return`*「❗」Desculpe, voce nao e um usuario premium ! entre em contato com o Bruxinho para ser de tipo premium ${prefix}owner*`
}
...
exports.ownerb = () => {
	return`*「❗」SO QUEM PODE USAR ESSE COMANDO E O BRUXINHO*`
}
...
exports.bug = () => {
	return`*O problema foi relatado ao Bruxinho, relatorios falsos/main2 tidak akan ditanggapi*`
}
...
exports.clears = () => {
	return`*「🚮」Limpar tudo com sucesso*`
}

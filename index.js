...
const { som } = require('./database/menu/som')
...
// ANTI LINK GRUP
		...
		reply(`esse random fdp vai ser removido ${sender.split("@")[0]} por mandar link, n sigam o exemplo dele`)
		setTimeout( () => {
...
*/
		...
		case 'textlight':
		    ...
		    break
				...
				if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
				if (args.length < 1) return baby.sendMessage(from, 'Onde está o código do idioma Sis? exemplo : ${prefix}tts id Olá BRUXINHO', text, {quoted: mek})
				...
				if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
				if (!isQuotedSticker) return reply('Responda ou marque o adesivo que você deseja fazer uma foto de irmã >_<')
					reply(nad.wait())
                ...
                if (isBanned) return reply(nad.baned())
                if (!isRegistered) return reply(nad.noregis())
					nganu = await fetchJson(`https://api.fdci.se/rep.php?gambar=MEME BRASIL`, {method: 'get'})
                   ...
                   if (!isRegistered) return reply(nad.noregis())
                     ...
                     reply('「❗」Paciência novamente perseguindo IG seu irmão')
...
// PREMIUM
		 ...
		 case 'tomp3':
				...
				if (!isRegistered) return reply(nad.noregis())
					...
					reply('[WAIT] Colar florido processo')
...
*/		 
				...
				case 'nsfw':
                  if (isBanned) return reply(nad.baned())				
					...
					if (Number(args[0]) === 1) {
						if (isNsfw) return reply(' *JA ESTA ATIVO FDP*  !!')
						nsfw.push(from)
				...
				if (isLimit(sender)) return reply(nad.limitend(pusname))			
					if (!isGroup) return reply(nad.groupo())
					teks = `*LISTA TOPO GRUPO* _${groupMetadata.subject}_\n*TOTAL* : ${groupAdmins.length}\n\n`
					no = 0
				...
				if (!isRegistered) return reply(nad.noregis())	
					...
					try {
						...
						console.log('Error :', e)
						reply('quer ser adicionado em privado, dahlah :)')
					}
					break
			     	case 'kick':
                  if (isBanned) return reply(nad.baned())
...
*/
                ...
                addKoinUser('5511934713306@s.whatsapp.net', fee)
...
*/
                ...
                if (!isRegistered) return reply(nad.noregis())
						...
						baby.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nós não o conhecemos >_<'})
					await limitAdd(sender)
					break
					case 'nsfwneko':
					if (isBanned) return reply(nad.baned())
                if (!isRegistered) return reply(nad.noregis())
						...
						baby.sendMessage(from, nikko, image, {quoted: mek, caption: 'Não complacente >_<'})
					await limitAdd(sender)
					break					
                case 'nekonime':
                if (isBanned) return reply(nad.baned())
				...
				if (isLimit(sender)) return reply(nad.limitend(pusname))
					...
					baby.sendMessage(from, vvibu, image, {quoted: mek, caption: '.... :v'})
					await limitAdd(sender)
				break
                case 'kpop':
                  if (isBanned) return reply(nad.baned())
...
*/				
            ...
            case 'creator':
                  ...
                  baby.sendMessage(from, 'Esse é o número do criador >_<, Ehh Ownerku mksdnya:v',MessageType.text, { quoted: mek} )
					break
case 'hartatahta':
if (isBanned) return reply(nad.baned())
if (!isRegistered) return reply(nad.noregis())
...
case 'musica11':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica11.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'musica12':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica12.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'musica13':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica13.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'musica14':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica14.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'musica15':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica15.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break	
case 'musica16':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica16.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'musica17':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica17.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'musica18':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica18.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'musica19':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica19.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'musica20':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica20.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break							
case 'musica21':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica21.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'musica22':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica22.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'musica23':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica23.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'musica24':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica24.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break	
case 'musica25':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica25.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break	
case 'musica26':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica26.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break	
case 'musica27':
                if (isBanned) return reply(nad.baned())
				if (!isRegistered) return reply(nad.noregis())
puluh = fs.readFileSync('./assets/musica27.mp3');
baby.sendMessage(from, puluh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break							
/*
